                ...
                <div class="portfolio-card" data-category="${p.category || 'landing'}">
                    ...
                    <div class="portfolio-info">
                        ...
                        <div class="portfolio-card-footer">
                            ...
                            <a href="${p.demoUrl}" target="_blank" rel="noopener noreferrer" class="btn btn-sm btn-primary" style="width: 100%; text-decoration: none; display: inline-flex; align-items: center; justify-content: center; gap: 5px;">
